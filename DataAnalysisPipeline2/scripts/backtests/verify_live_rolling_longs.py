...
def main():
    ...
    print("\n[Ingestion] Fetching live pricing bars from 2024-11-01 to 2026-05-22...")
    df_list = []
    for ticker in basket:
        ticker_df = yf.download(ticker, start="2024-11-01", end="2026-05-23", progress=False)
    ...
    try:
        ...
        plt.title("Rolling Out-of-Sample Long Strategy Real-World Performance (1-Year Window)", fontsize=13, fontweight="bold", pad=15)
