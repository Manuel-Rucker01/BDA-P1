"""
Data Collector for Company Acquisitions
...
FINAL_CSV_PATH = os.path.join(DATASETS_DIR, "company_acquisitions.csv")
os.makedirs(DATASETS_DIR, exist_ok=True)

# Dataset configuration
DATASET = "shivamb/company-acquisitions-7-top-companies" 
